...
public class NthUglyNumber {
   ...
   public static int findNthUglyNumberEff(int n) {
      ...
      while (count != n) {
         ...
         count++;
         val = uglyNumber;
         if (!possible.contains(2 * uglyNumber))
            possible.add(2 * uglyNumber);
         if (!possible.contains(3 * uglyNumber))
            possible.add(3 * uglyNumber);
         if (!possible.contains(5 * uglyNumber))
            possible.add(5 * uglyNumber);
      }
