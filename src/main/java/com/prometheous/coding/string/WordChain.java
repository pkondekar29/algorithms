 ...
 * it is possible to arrange all of the plates in a sequence (according to the given rule) and consequently to open
 * the door.
 */
public class WordChain {
   ...
   private static boolean DFS(String[] words, int curr, int prev, int count, boolean[] visited) {
      ...
      if (curr >= words.length)
         return false;      // If curr over flows, return
