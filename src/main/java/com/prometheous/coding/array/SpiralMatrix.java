...
public class SpiralMatrix {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(traverseSpiral(arr1).stream().map(Object::toString)
    ...
    private static List<Integer> traverseSpiral(int[][] arr) {
        ...
        while(c < total) {
            System.out.println(String.format("c: %d, m: %d, n: %d, lcc: %d, rcc: %d, trc: %d, brc: %d, i: %d, j: %d", c, m, n, lcc, rcc, trc, brc, i, j));
