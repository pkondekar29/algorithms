...
public class HouseRobberTest {
   ...
   public static Stream<Arguments> all1() {
      ...
      return Stream.of(Arguments.of(new int[] { 2, 7, 9, 3, 1 }, 12), Arguments.of(new int[] { 1, 2, 3, 1 }, 4));
   }

   public static Stream<Arguments> all2() {

      return Stream.of(Arguments.of(new int[] { 2, 7, 9, 3, 1 }, 11), Arguments.of(new int[] { 1, 2, 3 }, 3),
